  ...
  if (!lobby && !gameState) {
    ...
    return (
      <div className="flex flex-col h-screen bg-black text-white overflow-y-auto p-4 space-y-6">
        <div className="flex items-center justify-between p-4 bg-white/5 border-b border-white/10 flex-shrink-0 z-30 backdrop-blur-md max-w-6xl mx-auto w-full rounded-2xl">
